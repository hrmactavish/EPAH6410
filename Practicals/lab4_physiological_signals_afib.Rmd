...
3. Test against patients with other cardiac arrhythmia (e.g. ventricular tachycardia) to assess whether the models can correctly distinguish AF from other conditions that also produce irregular R-R intervals, not just AF versus a healthy Normal rhythm.
