...
None of the models had what would typically be considered strong discrimination (AUC $\ge$ 0.80), but the best was Time (ARIMA) with an AUC of 0.692, followed by Frequency (logistic regression)	with an AUC of 0.625. The HMM state-space model performed the worst (AUC = 0.579).

This suggests that the predictability of R-R intervals was the most useful feature for detecting AF in this dataset, while the frequency and state-space approaches were less effective.
