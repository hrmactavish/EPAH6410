...
In this HMM, the observed variables are the measured R-R intervals. The hidden variables are the underlying rhythm states that generated the intervals, which are never directly measured but is inferred by the model from the pattern of intervals. The two states correspond to a "regular" and a more "irregular" AF-like state.
